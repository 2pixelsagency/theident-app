  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f1f0ee', fontFamily: 'system-ui, sans-serif' }}>
      <style>{`
        ...
        .mob-nav-btn { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px; flex: 1; padding: 10px 0 12px; text-decoration: none; min-height: 60px; -webkit-tap-highlight-color: transparent; }
